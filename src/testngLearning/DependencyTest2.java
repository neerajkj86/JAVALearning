...
public class DependencyTest2 
{
	...
	@TestStudent4(dependsOnMethods = "A",groups = "sniff")
	public void B()
	{
	System.out.println("In test B");
	
	}
	@TestStudent4(dependsOnMethods="A",alwaysRun = true) //Soft Dependency where we can still execute the dependent test by marking as always run = true
	public void C()
	{
	...
	@TestStudent4(dependsOnMethods="A")
	public void D()
	{
